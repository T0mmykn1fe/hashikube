...
__On your Host computer__ in `hashikube/hashicorp/packer/windows` folder, please do:

*~/workspace/hashikube/hashicorp/packer/windows $* `packer inspect windows_2019.json`
```
...
*~/workspace/hashikube/hashicorp/packer/windows $* `packer build --only=virtualbox-iso windows_2019.json`
...
*~/workspace/hashikube/hashicorp/packer/windows $* `ls -lah | grep box`
```
-rw-r--r--   1 hashikube  staff   4.5G 12 Jan 21:18 windows_2019_virtualbox.box
```

### Build RedHat Virtualbox-iso

__On your Host computer__ in `hashikube/hashicorp/packer/linux/rhel` folder, please do:

*~/workspace/hashikube/hashicorp/packer/linux/rhel $* `packer build --only=virtualbox-iso rhel8.json`
...
==> virtualbox-iso: Trying /Applications/VirtualBox.app/Contents/MacOS/VBoxGuestAdditions.iso
==> virtualbox-iso: /Applications/VirtualBox.app/Contents/MacOS/VBoxGuestAdditions.iso => /Users/hashikube/workspace/hashikube/hashicorp/packer/linux/rhel/packer_cache/7784a55a71d48a1e9b5c487431438fef0f19d87f.iso
==> virtualbox-iso: Retrieving ISO
...
==> virtualbox-iso: iso/rhel-8.1-x86_64-dvd.iso?checksum=sha256%3A2323ad44d75df1a1e83048a34e196ddfedcd6c0f6c49ea59bf08095e3bb9ef65 => /Users/hashikube/workspace/hashikube/hashicorp/packer/linux/rhel/packer_cache/e0829642bf518828676fda5c2502fd75ea3a305b.iso
...
*~/workspace/hashikube/hashicorp/packer/linux/ubuntu $* `vagrant ssh -c "cd /vagrant/hashicorp/packer/linux/ubuntu; packer build ubuntu16.04.json"`
```
